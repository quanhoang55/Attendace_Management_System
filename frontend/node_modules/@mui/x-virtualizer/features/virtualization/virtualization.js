...
function useVirtualization(store, params, api) {
  ...
  const scrollCache = (0, _useLazyRef.default)(() => createScrollCache(isRtl, rowBufferPx, columnBufferPx, rowHeight * 15, MINIMUM_COLUMN_WIDTH * 6, layoutMode)).current;
  ...
  const triggerUpdateRenderContext = (0, _useEventCallback.default)(() => {
    ...
    scrollCache.buffer = bufferForDirection(isRtl, direction, rowBufferPx, columnBufferPx, rowHeight * 15, MINIMUM_COLUMN_WIDTH * 6, layoutMode);
